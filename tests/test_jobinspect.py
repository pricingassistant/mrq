...
@pytest.mark.parametrize(["p_testtype", "p_testparams", "p_type", "p_subtype", "p_data"], [
...
def test_current_job_trace_io(worker, p_testtype, p_testparams, p_type, p_subtype, p_data):
